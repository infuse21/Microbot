...
| Broken Raft / desert gate requirements, 2026-09-06 | Raft routing and pre-dispatch require both equipped tools; paid Al Kharid action filtered after Prince Ali Rescue; six Shantay ticket rows consumable, Desert Elite entry free with no vendor purchase. | Rebuilt-client missing-tool reroute, equipment removal/breakage memo invalidation, equipped raft crossing, pre/post-quest toll action, repeated banked tickets/fares, elite free entry including Unkah. No barehanded raft protocol or new Shantay/raft movement ownership is claimed. |
